...
public class CommonCard1 extends CommonCard {
     ...
     * Class constructor
     *
     * @param identifier  unique identifier associated to the card. Required to find
     *                    asset location on client
    ...
    /**
     * Method that check if there are two groups each containing four tiles of the
     * same type in a 2x2 square.
     * 
